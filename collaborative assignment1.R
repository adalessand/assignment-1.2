...
names(women)  #gives me the height and the weights 
?women # provides me with the format of the dataset being: A data frame with 15 observations on 2 variables.
[,1]	height	numeric	Height (in)
[,2]	weight	numeric	Weight (lbs)
summary(women) # proivding me with descriptive statistics on both vaariable with, mean, median, min-max of the variables
require(graphics) # to plot the correlation between height and weight which in this case is positive and linear
